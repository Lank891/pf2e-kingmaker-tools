...
const structures: Structure[] = [
    ...
    {
        name: 'Guildhall',
        notes: 'While in a settlement with a guildhall, you gain a +1 item bonus to all related skill checks to Earn Income or to Repair. The level of this settlement is treated as 1 higher for the purposes of calculating Earn Income task level.',
        traits: ['building'],
        affectsDowntime: true,
        reducesUnrest: false,
        level: 5,
    ...
    },
    {
        ...
        notes: 'While in a settlement with an opera house, you gain a +3 item bonus to Performance checks made to Earn Income. The level of this settlement is treated as 2 higher for the purposes of calculating Earn Income task level.',
        traits: ['building', 'edifice', 'famous', 'infamous'],
        affectsDowntime: true,
        reducesUnrest: true,
        reduceUnrestBy: {
    ...
    {
        name: "Pathfinder Society Lodge",
        notes: "Only one Pathfinder Society Lodge can be built in the kingdom. While in the city with the lodge, you can manage mercenaries and send them on adventures. The DC of random encounter is lowered by 1.",
        traits: [
          "building"
        ],
        reducesUnrest: false,
    ...
    },
    {
        ...
        notes: 'If attempt a Performance check to Earn Income in a settlement with a luxury tavern, you gain a +2 item bonus to the check. All checks made to Gather Information in a settlement with at least one luxury tavern gain a +2 item bonus. The level of this settlement is treated as 1 higher for the purposes of calculating Earn Income task level.',
    ...
    },
    {
        ...
        notes: 'If you attempt a Performance check to Earn Income in a settlement with a popular tavern, you gain a +1 item bonus to the check. All checks made to Gather Information in a settlement with at least one popular tavern gain a +1 item bonus. The level of this settlement is treated as 1 higher for the purposes of calculating Earn Income task level.',
        traits: ['building'],
        affectsDowntime: true,
        reducesUnrest: true,
        reduceUnrestBy: {
    ...
    },
    {
        ...
        notes: 'If you attempt a Performance check to Earn Income in a settlement with a world-class tavern, you gain a +3 item bonus to the check. All checks made to Gather Information in a settlement with a world-class tavern gain a +3 item bonus. The level of this settlement is treated as 2 higher for the purposes of calculating Earn Income task level.',
    ...
    },
    {
        ...
        notes: 'While in a settlement with a theater, you gain a +2 item bonus to Performance checks made to Earn Income. The level of this settlement is treated as 1 higher for the purposes of calculating Earn Income task level.',
        traits: ['building'],
        affectsDowntime: true,
        reducesUnrest: true,
        reduceUnrestBy: {
